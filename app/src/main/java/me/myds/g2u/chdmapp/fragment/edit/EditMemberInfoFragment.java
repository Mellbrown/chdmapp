...
import me.myds.g2u.chdmapp.activity.update.UpdateMemberActivity;
...
public class EditMemberInfoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View viewLayout = inflater.inflate(R.layout.fragment_edit_member_info, container,false);
        ...
        adapter = new BaseRecyclerAdapter<MemberInfo, MemberInfoViewHolder>(
            ...
            @Override
            public void onCreateAfterViewHolder(final MemberInfoViewHolder holder) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(getContext(), UpdateMemberActivity.class);
                        MemberInfo memberInfo = dataList.get(holder.getLayoutPosition());
                        intent.putExtra("uid",memberInfo.uid);
